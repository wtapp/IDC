#!/usr/bin/perl -w
##tiff2jpg.pl
##Christian Science Monitor testing
## INPUT: Soft-copy scanned in-bound TIFF images
## OUTPUT: Converted to JPG images
## Non-destructive uses IN/OUT dir

##7.19.2011 XWWT - Created from base cropper tool
...
my $base = "U:/CSPS/PROCESSING"; #changed bc UNC paths were failing in File::
my $baseindir = $base."/TIFF_PROCESSED";
my $baseoutdir = $base."/JPG_COMPLETE";
