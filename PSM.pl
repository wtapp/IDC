#!/usr/bin/perl -w
##PSM.pl
##Gale/Cengage Liberty Magazine Project
...
my $base = "T:/PSM/Delivered/Shipment_7"; #changed bc UNC paths were failing in File::
my $baseindir = $base."/IN/0230";
my $baseoutdir = $base."/OUT/0230";
...
=POD    
    ...
    $err=$oimage->Write($n);
=cut    
    #$err=$oimage->Set('jpeg:extent'=>'2500kb');
    
    my $errState = system("convert $_  -define jpeg:extent=2500kB -resample 400x400 -colorspace gray $n");
